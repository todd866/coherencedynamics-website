---
slug: time-from-dimensions
title: Time From Dimensions
subtitle: Why time slows when the aperture squeezes
date: 2025-12-28
tags:
  - time
  - dimensionality
  ...
  - consciousness
  - physics
summary: Time dilation and dimensional contraction are the same phenomenon. Squeeze the aperture, slow the clock—whether it's a black hole, a spaceship, or a brain.
relatedPapers:
...
### The aperture is observer-relative
...
This connects to the [minimal embedding dimension paper](/papers/minimal-embedding)—the minimum dimensionality needed to represent dynamics faithfully.
